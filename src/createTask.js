...
export class Task {
  ...
  generateTasks() {
    ...
    taskLibrary.forEach( task => {
      ...
      const dueDate = createElement('div', 'task-due-date property', {}, task.dueDate);
      const workTime = createElement('div', 'task-work-time property', {}, task.workTime);
      const progress = createElement('div', 'task-progress property', {}, task.progress);
      const tag = createElement('div', 'task-tag property', '', task.tag);

      const iconSection = createElement('div', 'icon-section');
      const clockIcon = createSVG('0 0 512 512', 'M464 256A208 208 0 1 1 48 256a208 208 0 1 1 416 0zM0 256a256 256 0 1 0 512 0A256 256 0 1 0 0 256zM232 120l0 136c0 8 4 15.5 10.7 20l96 64c11 7.4 25.9 4.4 33.3-6.7s4.4-25.9-6.7-33.3L280 243.2 280 120c0-13.3-10.7-24-24-24s-24 10.7-24 24z', 'task-icon');
      const clockDiv = createElement('div','', {id: 'clock-icon'});
      clockDiv.append(clockIcon);
      const calendarIcon = createSVG('0 0 448 512', 'M152 24c0-13.3-10.7-24-24-24s-24 10.7-24 24l0 40L64 64C28.7 64 0 92.7 0 128l0 16 0 48L0 448c0 35.3 28.7 64 64 64l320 0c35.3 0 64-28.7 64-64l0-256 0-48 0-16c0-35.3-28.7-64-64-64l-40 0 0-40c0-13.3-10.7-24-24-24s-24 10.7-24 24l0 40L152 64l0-40zM48 192l352 0 0 256c0 8.8-7.2 16-16 16L64 464c-8.8 0-16-7.2-16-16l0-256z', 'task-icon');
      ...
      iconSection.append(clockIcon, calendarIcon, progressIcon, categoryIcon);
